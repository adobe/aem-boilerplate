...
All Rights Reserved. */
import{f as o,h as i}from"./network-error.js";import{h as u}from"./fetch-error.js";import{d as p}from"./updateCompanyUser.js";const c=`
...
`;async function g(a){const n={name:a.name,description:a.description,target_id:a.targetId};return await o(c,{variables:{input:n}}).then(e=>{var r,m,d;if((r=e.errors)!=null&&r.length)return u(e.errors);const t=(d=(m=e==null?void 0:e.data)==null?void 0:m.createCompanyTeam)==null?void 0:d.team;return t?{id:t.id,structureId:t.structure_id,name:t.name}:null}).catch(i)}const y=`
...
`;async function w(a){const n={id:a.id,name:a.name,description:a.description};return await o(I,{variables:{input:n}}).then(e=>{var t,r,m,d;return(t=e.errors)!=null&&t.length?u(e.errors):!!((d=(m=(r=e==null?void 0:e.data)==null?void 0:r.updateCompanyTeam)==null?void 0:m.team)!=null&&d.id)}).catch(i)}export{M as a,w as b,g as c,A as d,$ as g,S as u};
