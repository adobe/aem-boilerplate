...
export type BundleProduct = CustomizableProductInterface & PhysicalProductInterface & ProductInterface & RoutableInterface & {
    ...
    rules?: Maybe<Array<Maybe<CatalogRule>>>;
...
export type Cart = {
    ...
    rules?: Maybe<Array<Maybe<CartRule>>>;
...
export type CatalogRule = {
    __typename?: 'CatalogRule';
    /** Name of the catalog rule */
    name: Scalars['String']['output'];
};
...
export type Customer = {
    ...
    gift_registry?: Maybe<GiftRegistry>;
    /** Name of the customer group assigned to the customer */
...
export type CustomerSegment = {
    ...
    /** Customer segment is applicable to visitor, registered customer or both. */
...
export declare enum CustomerSegmentApplyTo {
...
export type Query = {
    ...
    allCartRules?: Maybe<Array<Maybe<CartRule>>>;
    /** Provides all active catalog rules in the store. */
    allCatalogRules?: Maybe<Array<Maybe<CatalogRule>>>;
    /** An array containing a list of all Customer Groups available. */
    allCustomerGroups?: Maybe<Array<Maybe<CustomerGroup>>>;
    /** List of all active customer segments. */
    allCustomerSegments?: Maybe<Array<Maybe<CustomerSegment>>>;
    ...
    customerSegments?: Maybe<Array<Maybe<CustomerSegment>>>;
...
export type StoreConfig = {
    ...
    /** Configuration data from customer/account_information/graphql_share_all_customer_groups */
    graphql_share_all_customer_groups: Scalars['Boolean']['output'];
    ...
    /** Configuration data from catalog/rule/share_all_catalog_rules */
    share_all_catalog_rules: Scalars['Boolean']['output'];
    /** Configuration data from promo/graphql/share_all_sales_rule */
    share_all_sales_rule: Scalars['Boolean']['output'];
    /** Configuration data from catalog/rule/share_applied_catalog_rules */
    share_applied_catalog_rules: Scalars['Boolean']['output'];
    /** Configuration data from promo/graphql/share_applied_sales_rule */
    share_applied_sales_rule: Scalars['Boolean']['output'];
...
export type Set_Shipping_Address_On_Cart_MutationMutationVariables = Exact<{
    cartId: Scalars['String']['input'];
    shippingAddressInput: ShippingAddressInput;
}>;
export type Set_Shipping_Address_On_Cart_MutationMutation = {
    __typename?: 'Mutation';
...
export type Set_Shipping_Address_On_Cart_And_Use_As_Billing_MutationMutationVariables = Exact<{
    cartId: Scalars['String']['input'];
    shippingAddressInput: ShippingAddressInput;
}>;
export type Set_Shipping_Address_On_Cart_And_Use_As_Billing_MutationMutation = {
    __typename?: 'Mutation';
    setShippingAddressesOnCart?: {
        __typename?: 'SetShippingAddressesOnCartOutput';
        cart: {
