...
describe('transformCustomerOrdersReturns', () => {
    beforeEach(() => {
        jest.resetAllMocks();
    });
    it('should return null if response is null', () => {
        const result = (0, transform_customer_orders_returns_1.transformCustomerOrdersReturns)(null);
        expect(result).toBeNull();
    });
    it('should return null if response does not have customer returns items', () => {
        const response = { items: [] };
        const result = (0, transform_customer_orders_returns_1.transformCustomerOrdersReturns)(response);
        expect(result).toBeNull();
    });
