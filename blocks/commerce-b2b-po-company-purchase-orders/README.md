...
7. **Block-Specific Permission Check**: Checks for admin or company-wide purchase order permission (`VIEW_COMPANY`) for this specific block
...
9. **Orders Display**: If authorized, renders company purchase orders with pagination using default dropin configuration
