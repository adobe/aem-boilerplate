...
All Rights Reserved. */
import{CUSTOMER_INFORMATION_FRAGMENT as O}from"../fragments.js";import{f as s,h as u}from"./network-error.js";import{s as b}from"./setReCaptchaToken.js";import"@dropins/tools/event-bus.js";import"@dropins/tools/recaptcha.js";import{merge as p}from"@dropins/tools/lib.js";import{c as N}from"./getCustomerRolePermissions.js";import{t as F}from"./transform-attributes-form.js";import{h as S}from"./verifyToken.js";const I=`
...
`,j=async r=>await s(v,{method:"GET",cache:"force-cache",variables:{formCode:r}}).then(e=>{var o;return(o=e.errors)!=null&&o.length?S(e.errors):F(e)}).catch(u),y=`
